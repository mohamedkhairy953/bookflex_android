...
public final class ViewLoadingBinding implements ViewBinding {
  ...
  private ViewLoadingBinding(@NonNull View rootView, @NonNull ProgressBar progressBar) {
  ...
  public static ViewLoadingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    inflater.inflate(R.layout.view_loading, parent);
    return bind(parent);
  }
  ...
  public static ViewLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewLoadingBinding(rootView, progressBar);
    }
